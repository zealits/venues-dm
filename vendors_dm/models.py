...
class VenueFacilities(models.Model):
    ...
    layout_floor_plan = models.TextField(default=None, null=True, blank=True)
    accessibility_features = models.TextField(default=None, null=True, blank=True)
    ...
    technical_equipment = models.TextField(default=None, null=True, blank=True)
...
class VenueBookings(models.Model):
    ...
    full_payment_due_date = models.DateField(default=None, null=True, blank=True)
...
class VenueEvents(models.Model):
    ...
    photos_from_past_events = models.ManyToManyField('VenuePhotos', blank=True)
    ...
    preferred_event_types = models.TextField(default=None, null=True, blank=True)
...
# Define the Vendor Social Media Handles Model
class VendorSocialMediaHandles(models.Model):
    """
    Represents social media handles associated with venues.
    """
    social_media_handle_id = models.AutoField(primary_key=True)
    vendor = models.ForeignKey(Vendors, on_delete=models.CASCADE, default=None, null=True, blank=True)
    facebook_url = models.URLField(max_length=255, default=None, null=True, blank=True)
    instagram_url = models.URLField(max_length=255, default=None, null=True, blank=True)
    twitter_url = models.URLField(max_length=255, default=None, null=True, blank=True)
    linkedin_url = models.URLField(max_length=255, default=None, null=True, blank=True)
