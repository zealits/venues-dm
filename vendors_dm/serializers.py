...
class VendorSocialMediaHandlesSerializer(serializers.ModelSerializer):
    """
    Serializer for VendorSocialMediaHandles model.

    This serializer is used to convert VendorSocialMediaHandles model instances into JSON data.
    It includes all fields of the VendorSocialMediaHandles model.
    """
    class Meta:
