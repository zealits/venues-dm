...
from .serializers import (
    ...
    VendorsSerializer,
    VendorSocialMediaHandlesSerializer,
...
class VendorSocialMediaHandlesViewSet(viewsets.ModelViewSet):
    """
    Viewset for VendorSocialMediaHandles model.

    This viewset provides CRUD (Create, Read, Update, Delete) operations for the VendorSocialMediaHandles model.
    It uses the VendorSocialMediaHandlesSerializer for serialization and deserialization.
    """
